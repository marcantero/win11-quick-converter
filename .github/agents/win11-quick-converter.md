...
8. **Pull requests**: Create a pull request whenever the current work is ready for review or when a branch represents a coherent change set that should be merged independently.